...
\subsection{$Random\quad Arrival$}
    \begin{description}
    	\item[ランダムな到着]\mbox{}\\
        	...
        	\begin{align}
        		\prob{A_{(\tau, \tau + t]} = n} &= \lim_{T \to \infty} \cprob{A_{(\tau, \tau + t]} = n}{A_{(0, T]}=x} \\
                &= \lim_{T \to \infty} \frac{x!}{n!(x-n)!} \left( \frac{t}{T} \right)^n \left( \frac{T-t}{T} \right)^{x-n} \\
                &= \lim_{T \to \infty} \frac{t^n}{n!} \left( 1 - \frac{t}{T} \right)^{x} \frac{x(x-1)(x-2)\cdots(x-n+1)}{(T-t)^n} \\
                &= \lim_{T \to \infty} \frac{t^n}{n!} \left( 1 - \frac{t}{T} \right)^{\lambda T + o(T)} 
...
\subsection{$Stationary\quad Process$}
    ...
    \begin{Proof}
        ...
        \qed
    \end{Proof}
    極限分布の存在と定常分布の関係をもう少し見る．$Kolmogorov$の前進方程式(式(\refeq{eq:kolmogorov_forward}))より
    \begin{align}
    	\begin{cases}
    		\frac{dP_{ij}(t)}{dt} = \mu P_{i\ j+1}(t) - (\lambda + \mu) P_{ij}(t) + \lambda P_{i\ j-1}(t) & \text{$j \geq 1$} \\
            \frac{dP_{i0}(t)}{dt} = \mu P_{i 1}(t) - \lambda P_{i0}(t) & \text{$j = 0$} \\
...
\section{$Forward\quad Equations\quad of\quad Kolmogorov\quad on\quad M/M/\infty$}
    ...
    今まではサービス時間の系列を一本の軸で考えてきた．この章以降は，時系列を最大無限本まで考えねばならない．
    図にすると以下の様に表せる．\\
    \begin{description}
    	\item[前章まで,]
    \begin{picture}(500,50)(0,0)
    	\put(  0, 25){\vector(1,0){450}}
        \put(  0,  0){\vector(0,1){50}}
        \qbezier[20](  0, 25)( 25, 40)( 50, 25)
        \qbezier[20]( 50, 25)(100, 40)(150, 25)
        \qbezier[20](150, 25)(170, 40)(190, 25)
        \qbezier[20](190, 25)(220, 40)(250, 25)
        \qbezier[20](250, 25)(300, 40)(350, 25)
        \qbezier[20](350, 25)(360, 40)(370, 25)
        \qbezier[20](370, 25)(400, 40)(430, 25)
    \end{picture}
    
    	\item[本章以降,]\mbox{}\\
        	今まで考えてきた系列を複数本に増やし並列に考える．
    \begin{picture}(500,100)(0,0)
    	\put(  0, 20){\vector(1,0){450}}
        \put(  0, 40){\vector(1,0){450}}
        \put(  0, 60){\vector(1,0){450}}
        \put(  0,  0){\vector(0,1){100}}
        
        \qbezier[50](  0, 20)( 25, 30)( 50, 20)
        \qbezier[50]( 50, 20)(100, 30)(150, 20)
        \qbezier[50](150, 20)(170, 30)(190, 20)
        \qbezier[50](190, 20)(220, 30)(250, 20)
        \qbezier[50](250, 20)(300, 30)(350, 20)
        \qbezier[50](350, 20)(360, 30)(370, 20)
        \qbezier[50](370, 20)(400, 30)(430, 20)
        
        \qbezier[50](  0, 40)( 15, 50)( 30, 40)
        \qbezier[50]( 30, 40)( 60, 50)( 90, 40)
        \qbezier[50]( 90, 40)(150, 50)(210, 40)
        \qbezier[50](210, 40)(260, 50)(310, 40)
        \qbezier[50](310, 40)(330, 50)(350, 40)
        \qbezier[50](350, 40)(360, 50)(370, 40)
        \qbezier[50](370, 40)(390, 50)(410, 40)
        
        \qbezier[50](  0, 60)( 15, 70)( 30, 60)
        \qbezier[50]( 30, 60)( 80, 70)(130, 60)
        \qbezier[50](130, 60)(150, 70)(170, 60)
        \qbezier[50](170, 60)(220, 70)(270, 60)
        \qbezier[50](270, 60)(330, 70)(390, 60)
        \qbezier[50](390, 60)(400, 70)(410, 60)
        \qbezier[50](410, 60)(430, 70)(450, 60)
        
        \thicklines
        \put(  0,  0){\vector(1,0){480}}
        \multiput( 30,  0)(0,2){30}{\line(0,1){0.01}}
        \multiput( 50,  0)(0,2){10}{\line(0,1){0.01}}
        \multiput( 90,  0)(0,2){20}{\line(0,1){0.01}}
        \multiput(130,  0)(0,2){30}{\line(0,1){0.01}}
        \multiput(150,  0)(0,2){10}{\line(0,1){0.01}}
        \multiput(170,  0)(0,2){30}{\line(0,1){0.01}}
        \multiput(190,  0)(0,2){10}{\line(0,1){0.01}}
        \multiput(210,  0)(0,2){20}{\line(0,1){0.01}}
        \multiput(250,  0)(0,2){10}{\line(0,1){0.01}}
        \multiput(270,  0)(0,2){30}{\line(0,1){0.01}}
        \multiput(310,  0)(0,2){20}{\line(0,1){0.01}}
        \multiput(350,  0)(0,2){20}{\line(0,1){0.01}}
        \multiput(370,  0)(0,2){20}{\line(0,1){0.01}}
        \multiput(390,  0)(0,2){30}{\line(0,1){0.01}}
        \multiput(410,  0)(0,2){30}{\line(0,1){0.01}}
        \multiput(430,  0)(0,2){10}{\line(0,1){0.01}}
        \multiput(450,  0)(0,2){30}{\line(0,1){0.01}}
    \end{picture}
    
    \end{description}
    
    下の図にて，一つ一つの系列では客の離脱は$Poisson$過程に従う．$t$時間の間に$n$人が離脱する確率は
    \begin{align}
    	\exp{-\mu t} \frac{(\mu t)^n}{n!}
    \end{align}
    であった．系内に$i(=0,1,2,3,\cdots)$人いるとする．もちろん$i=1$の場合は前章までと状況は同じ，$i=0$の場合は架空人物のサービスが始まると考える．
    このとき系列全ての系列の合併系列(図の一番下の系列)において，$t$時間の間に$n$人が離脱する確率は
    \begin{align}
    	\exp{-i \mu t} \frac{(i \mu t)^n}{n!}
    \end{align}
    と表される．((\ref{sec:appendix_poisson})参照)
...
\label{sec:principle_reflection}
    ...
    \begin{description}
	\item[鏡像の原理($Principle\quad of\quad reflection$)]\mbox{}\\
...
\label{sec:appendix_poisson}
	$X(\omega),\ Y(\omega)$をパラメータ$\lambda > 0$の$Poisson$分布$P_O(\lambda)$に独立に従う確率変数であるとする．
    ...
    従って，和の分布はパラメータ$2\lambda$の$Poisson$分布に従うとわかる．機能的に考えて，独立に$Poisson$分布$P_O(\lambda)$に従う任意の$s$個の確率変数
