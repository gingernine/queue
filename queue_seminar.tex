\documentclass[a4j,papersize,disablejfam,slide,11pt]{jsarticle}
...
\subsection{$Transient\quad Solution$}
    ...
    \begin{eqnarray}
        ...
        &=& 1.
    \end{eqnarray}
    最後の三段の式変形は，$\sum\limits_{k=-\infty}^{\infty} \prob{C_{(0, t]} = k}$と$\prob{C_{(0, t]} = k} = \rho^{k} \prob{C_{(0, t]} = -k}$を使った．\\
    従って，次が成り立つ．
    \begin{eqnarray}
