...
\subsection{指値/成行注文の時間間隔}
    ...
    \begin{figure}[h]
    	\begin{minipage}{0.5\hsize}
        	\begin{center}
    			\includegraphics[clip,width = 5.0cm]{graphics/afternoonMedian_limit_buy.eps}
            \end{center}
            \caption{\scriptsize 売り指値注文の一回の注文枚数の各日の中央値の頻度分布(2007年一年間，後場)}
        \end{minipage}
        \begin{minipage}{0.5\hsize}
        	\begin{center}
        		\includegraphics[clip,width = 5.0cm]{graphics/afternoonMedian_limit_sell.eps}
            \end{center}
            \caption{\scriptsize 買い指値注文の一回の注文枚数の各日の中央値の頻度分布(2007年一年間，後場)}
        \end{minipage}
    \end{figure}
    \begin{figure}[H]
        \begin{minipage}{0.5\hsize}
        	\begin{center}
        		\includegraphics[clip,width = 5.0cm]{graphics/afternoonMedian_market_buy.eps}
            \end{center}
            \caption{\scriptsize 売り成行注文の一回の注文枚数の各日の中央値の頻度分布(2007年一年間，後場)}
        \end{minipage}
        \begin{minipage}{0.5\hsize}
        	\begin{center}
        		\includegraphics[clip,width = 5.0cm]{graphics/afternoonMedian_market_sell.eps}
            \end{center}
            \caption{\scriptsize 買い成行注文の一回の注文枚数の各日の中央値の頻度分布(2007年一年間，後場)}
        \end{minipage}
    \end{figure}
    ...
    \begin{table}[H]
        ...
        \begin{tabularx}{\linewidth}{l|c|c|c|c|c} \bhline{1.5pt}
        		 & Mean & S.D. & Median & Minimum & Maximum \\ \hline \hline
				2006 & 0.03866172  & 0.133440576 & 0.004340278 & 0 & 0.833379097 \\ \hline
				2007 & 0.035357088 & 0.114849053 & 0.003011335 & 0 & 0.877673611 \\ \hline
				2008 & 0.064877164 & 0.173840332 & 0.003217641 & 0 & 0.996388889 \\ \hline
				2009 & 0.044370564 & 0.147848562 & 0.000625 & 0 & 0.978291317 \\ \hline
				2010 & 0.024565883 & 0.084909519 & 0.000139237 & 0 & 0.449690551 \\ \hline
				2011 & 0.00996674 & 0.03630927 & 0.000180196 & 0 & 0.293335736 \\ \hline
				2012 & 0.012287145 & 0.041685283 & 0.000405442 & 0 & 0.276624549 \\ \hline
				2013 & 0.018569784 & 0.061265307 & 0.001869664 & 0 & 0.519983779 \\ \hline
				2014 & 0.016606935 & 0.047625878 & 0.000630687 & 0 & 0.291937523 \\ \hline
				2015 & 0.021359796 & 0.06568593 & 0.000180221 & 0 & 0.385729106 \\ \hline
				2016 & 0.01898051 & 0.012149474 & 0.017457711 & 0 & 0.071640984 \\ \bhline{1.5pt}
        \end{tabularx}
...
\label{sec:appendix_errordata}
	\begin{description}
    	\item[最良気配値または最良気配にかかる数量が0となっているデータ]\mbox{}\\
        \item[最良買い気配値==最良売り気配値となっているデータ]\mbox{}\\
    \end{descriptiton}
